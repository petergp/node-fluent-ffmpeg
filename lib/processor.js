...
exports = module.exports = function Processor(command) {
  ...
  command.prototype.saveToFile = function(targetfile, startcalllback, callback) {
  ...
  command.prototype.writeToStream = function(stream, pipeOptions, process_callback, callback) {
